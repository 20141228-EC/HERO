...
void Ui_Info_Update(void)
{
  ...
  float pitch_imu_angle = (float)communicate.car_data0_rx_info->pitch_angel / 100.f; // 云台角度转浮点数
 ...
 /*视觉允许打弹状态UI更新****************************************************/
  ...
  uint8_t is_find_target = communicate.car_data0_rx_info->car_state.bit.is_find_target;

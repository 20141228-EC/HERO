...
{
	shoot_statistics.temperature_LF=rm_motor[FRIC_B_UP].info->temperature;
	shoot_statistics.speed_now=communicate.shoot_data_rx_info->shooting_speed;
    float s_speed =  communicate.shoot_data_rx_info->shooting_speed;
